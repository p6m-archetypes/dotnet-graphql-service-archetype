...
{% endif %}
    ...
    // Two Kestrel endpoints: GraphQL on service_port, management on management_port.
    ...
    // In production only reachable on management_port; in Testing accessible via test client.
