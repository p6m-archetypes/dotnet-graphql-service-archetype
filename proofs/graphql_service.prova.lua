--- Render-verification suite for the Dotnet GraphQL service archetype: each persistence variant lays
...
local function spec_for(persistence)
  return p6m.spec{
    language = "dotnet", shape = "full", transport = "graphql",
